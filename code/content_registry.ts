...
Buildings.register("base_assembler", MultiBlockController, { recipeType: recipes.base_assembling, multiblockSize: [2, 2], drawer: BuildingWithRecipe.outputDrawer(), secondary: Buildings.get("base_multiblock_secondary") as typeof MultiBlockSecondary });
