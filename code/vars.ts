...
const keybinds = extend<Keybinds>()({
	...
	placement: {
		...
		type_10: new Keybind("9", [], () => {placedBuilding.type = "base_compressor";}),
		type_11: new Keybind("f1", [], () => {placedBuilding.type = "base_lathe";}),
		type_12: new Keybind("f2", [], () => {placedBuilding.type = "base_assembler";}),
		type_13: new Keybind("f3", [], () => {placedBuilding.type = "base_arc_tower";}),
		type_14: new Keybind("f4", [], () => {placedBuilding.type = "base_power_source";}),		
